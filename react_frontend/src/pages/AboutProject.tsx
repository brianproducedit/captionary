      ...
      <div className="flex flex-col w-full">
        ...
        <div className="relative w-full overflow-hidden">
          ...
          <section className="relative pt-8 pb-[var(--spacing-space-3xl)] flex flex-col items-center text-center max-w-5xl mx-auto px-[var(--spacing-margin-mobile)]">
            ...
            <h1 className="tracking-tight font-bold max-w-4xl mx-auto leading-tight text-[length:var(--text-display-lg-mobile)] md:text-[length:var(--text-display-lg)]"
            ...
            <p className="mt-[var(--spacing-space-md)] max-w-3xl leading-relaxed"
            ...
            <div className="mt-[var(--spacing-space-2xl)] grid grid-cols-2 sm:grid-cols-4 gap-[var(--spacing-space-sm)] w-full max-w-4xl">
              <div className="p-[var(--spacing-space-md)] rounded flex flex-col items-center justify-center text-center"
                   style={{ backgroundColor: 'var(--color-surface-container-low)' }}>
                <span className="font-bold" style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-headline-md)', color: 'var(--color-primary)' }}>100%</span>
                <span className="uppercase tracking-wider mt-[var(--spacing-space-xxs)]" style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-caption-code)', color: 'var(--color-on-surface-variant)' }}>Free to Use</span>
              </div>
              <div className="p-[var(--spacing-space-md)] rounded flex flex-col items-center justify-center text-center"
                   style={{ backgroundColor: 'var(--color-surface-container-low)' }}>
                <span className="font-bold" style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-headline-md)', color: 'var(--color-tertiary)' }}>Private</span>
                <span className="uppercase tracking-wider mt-[var(--spacing-space-xxs)]" style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-caption-code)', color: 'var(--color-on-surface-variant)' }}>On-Device Only</span>
              </div>
              <div className="p-[var(--spacing-space-md)] rounded flex flex-col items-center justify-center text-center"
                   style={{ backgroundColor: 'var(--color-surface-container-low)' }}>
                <span className="font-bold" style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-headline-md)', color: 'var(--color-secondary)' }}>Fast</span>
                <span className="uppercase tracking-wider mt-[var(--spacing-space-xxs)]" style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-caption-code)', color: 'var(--color-on-surface-variant)' }}>Instant Results</span>
              </div>
              <div className="p-[var(--spacing-space-md)] rounded flex flex-col items-center justify-center text-center"
                   style={{ backgroundColor: 'var(--color-surface-container-low)' }}>
                <span className="font-bold" style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-headline-md)', color: 'var(--color-on-surface)' }}>AGPL-3.0</span>
                <span className="uppercase tracking-wider mt-[var(--spacing-space-xxs)]" style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-caption-code)', color: 'var(--color-on-surface-variant)' }}>Open Source</span>
              </div>
            </div>
          </section>
        </div>
        ...
        <section className="py-[var(--spacing-space-2xl)] max-w-7xl mx-auto w-full px-[var(--spacing-margin-mobile)]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-[var(--spacing-space-lg)]">
            {/* Pillar 1 */}
            <div className="group p-[var(--spacing-space-xl)] rounded-lg relative overflow-hidden transition-all duration-300 flex flex-col justify-between hover:shadow-[0_8px_30px_rgba(33,150,243,0.15)]"
                 style={{ backgroundColor: 'var(--color-surface-container-low)' }}>
            ...
            {/* Pillar 2 */}
            <div className="group p-[var(--spacing-space-xl)] rounded-lg relative overflow-hidden transition-all duration-300 flex flex-col justify-between hover:shadow-[0_8px_30px_rgba(120,220,119,0.15)]"
                 style={{ backgroundColor: 'var(--color-surface-container-low)' }}>
              <div className="absolute top-0 right-0 w-32 h-32 rounded-bl-full pointer-events-none transition duration-500 group-hover:scale-110"
            ...
            {/* Pillar 3 */}
            <div className="group p-[var(--spacing-space-xl)] rounded-lg relative overflow-hidden transition-all duration-300 flex flex-col justify-between hover:shadow-[0_8px_30px_rgba(249,171,255,0.15)]"
                 style={{ backgroundColor: 'var(--color-surface-container-low)' }}>
              <div className="absolute top-0 right-0 w-32 h-32 rounded-bl-full pointer-events-none transition duration-500 group-hover:scale-110"
              ...
              <div>
                ...
                <span className="uppercase tracking-wider font-semibold" style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-caption-code)', color: 'var(--color-secondary)' }}>Open Source</span>
                <h3 className="font-semibold mt-[var(--spacing-space-xs)] mb-[var(--spacing-space-sm)]" style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-headline-sm)', color: 'var(--color-on-surface)' }}>Free Forever</h3>
                <p className="leading-relaxed" style={{ fontFamily: 'var(--font-body)', fontSize: 'var(--text-body-md)', color: 'var(--color-on-surface-variant)' }}>
