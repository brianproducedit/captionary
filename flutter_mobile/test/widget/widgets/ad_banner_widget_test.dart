...
void main() {
  testWidgets('AdBannerWidget renders placeholder with correct text', (tester) async {
  ...
  testWidgets('AdBannerWidget accepts custom height', (tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Scaffold(
          body: AdBannerWidget(bannerHeight: 90.0),
        ),
      ),
    );

    final renderBox = tester.renderObject<RenderBox>(find.byType(AdBannerWidget));
