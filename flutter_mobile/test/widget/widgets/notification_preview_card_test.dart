...
void main() {
  ...
  testWidgets('NotificationPreviewCard renders title, timestamp, body text, and donate button', (WidgetTester tester) async {
    await tester.pumpWidget(buildTestableWidget(const NotificationPreviewCard()));
  ...
  testWidgets('Tapping Donate ☕ calls onDonateTap callback', (WidgetTester tester) async {
    bool tapped = false;
