...
void main() {
  ...
  testWidgets(
    'NotificationPermissionSheet renders title, body, and action buttons',
  ...
  testWidgets('Tapping Allow Notifications triggers onAllowed callback', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Tapping Not Now triggers onDismissed callback', (
    WidgetTester tester,
  ) async {
