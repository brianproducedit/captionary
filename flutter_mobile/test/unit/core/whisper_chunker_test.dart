...
void main() {
  ...
  group('WhisperChunker', () {
    test('returns single original chunk when audio duration is <= chunk duration', () async {
    ...
    test('slices long audio (> 30s) into overlapping 30s chunks and cleans up', () async {
      final wavData = WavHeaderValidator.createPcm16kMonoWav(
