...
void main() {
  ...
  group('SubscriptionProvider Tests', () {
    ...
    test('Initializes with Free Beta and generates a valid UUID deviceId', () async {
    ...
    test('unlockTier(creatorPro) sets permanent Pro status and lifts restrictions', () async {
      final prefs = await SharedPreferences.getInstance();
      final notifier = SubscriptionNotifier(prefs);
      await Future.delayed(const Duration(milliseconds: 10));
